...
// ADMIN_IDS dihitung di config/vars.js, diimpor langsung
const adminIds = cfg.ADMIN_IDS;
...
// ── Daftarkan handler payment modular ────────────────────────────────────────
const {
...
// ── Daftarkan handler admin modular ──────────────────────────────────────────
require('./handlers/admin').register(bot, {
  ...
  getTimeZone:         () => TIME_ZONE,
  getTopupBonus:       () => ({
    enabled:  TOPUP_BONUS_ENABLED,
    tier1Min: TOPUP_BONUS_MIN_AMOUNT,
    tier1Pct: TOPUP_BONUS_PERCENT,
    tier2Min: TOPUP_BONUS_TIER2_MIN,
    tier2Pct: TOPUP_BONUS_TIER2_PERCENT,
    tier3Min: TOPUP_BONUS_TIER3_MIN,
    tier3Pct: TOPUP_BONUS_TIER3_PERCENT,
  }),
  getSchedulerState:   () => ({
  ...
  getLastBroadcastInfo: () => lastBroadcastInfo,
  getTrialConfig,
});
